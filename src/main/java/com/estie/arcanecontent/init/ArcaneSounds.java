...
public class ArcaneSounds {
    public static final DeferredRegister<SoundEvent> SOUNDS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, ArcaneContent.MODID);
    
    public static final RegistryObject<SoundEvent> DRAGON_NUKE_CHARGE_FIRE =
            SOUNDS.register("dragon_nuke_charge_fire",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "dragon_nuke_charge_fire")));
    
    public static final RegistryObject<SoundEvent> DRAGON_NUKE_CHARGE_ICE =
            SOUNDS.register("dragon_nuke_charge_ice",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "dragon_nuke_charge_ice")));
    
    public static final RegistryObject<SoundEvent> DRAGON_NUKE_CHARGE_LIGHTNING =
            SOUNDS.register("dragon_nuke_charge_lightning",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "dragon_nuke_charge_lightning")));
    
    public static final RegistryObject<SoundEvent> DRAGON_NUKE_EXPLODE =
            SOUNDS.register("dragon_nuke_explode",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "dragon_nuke_explode")));
    
    public static final RegistryObject<SoundEvent> MRKRABS_SADGE =
            SOUNDS.register("mrkrabs_sadge",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "mrkrabs_sadge")));
    
    public static final RegistryObject<SoundEvent> MELEE_BLOCK_BREAK =
            SOUNDS.register("melee_block_break",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "melee_block_break")));
    
    public static final RegistryObject<SoundEvent> MELEE_PARRY =
            SOUNDS.register("melee_parry",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "melee_parry")));
    
    public static final RegistryObject<SoundEvent> FUNNEHSOUND =
            SOUNDS.register("funnehsound",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "funnehsound")));
    
    public static final RegistryObject<SoundEvent> BLOCK_OF_SILLY_MINE =
            SOUNDS.register("block_of_silly_mine",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "block_of_silly_mine")));
    ...
    public static final RegistryObject<SoundEvent> WITHER_BOSS_PHASE_1 =
            SOUNDS.register("wither_boss_phase_1",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "wither_boss_phase_1")));
    
    public static final RegistryObject<SoundEvent> WITHER_BOSS_PHASE_2 =
            SOUNDS.register("wither_boss_phase_2",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "wither_boss_phase_2")));
    
    public static final RegistryObject<SoundEvent> WITHER_BOSS_PHASE_3 =
            SOUNDS.register("wither_boss_phase_3",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ArcaneContent.MODID, "wither_boss_phase_3")));
}