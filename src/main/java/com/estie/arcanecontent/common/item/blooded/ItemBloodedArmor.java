package com.estie.arcanecontent.common.item.blooded;
...
import com.estie.arcanecontent.init.ArcaneArmorMaterials;
...
public class ItemBloodedArmor extends ArmorItem {//implements IProtectAgainstDragonItem {
    ...
    public ItemBloodedArmor(BloodedDragonType dragonType, Type slot) {
        super(ArcaneArmorMaterials.getBloodedArmorFromElement(dragonType.getElement()), slot,
                new Properties());
