package com.estie.arcanecontent.common.block;
...
public class BlockOfSilly extends Block {
    ...
    public static class RenderHandler {
        ...
        private static final ResourceLocation SILLY_TEXTURE = new ResourceLocation(ArcaneContent.MODID, "textures/block/block_of_silly.png");
        ...
        public static void onClientTick(TickEvent.ClientTickEvent event) {
            if (event.phase == TickEvent.Phase.END) {
                ...
                int radius = ArcaneContent.tweaksLoaded() ? Config.blockSillyVisualsRadius : 1;
